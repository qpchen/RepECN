...
def get_model_interpretation(model, img_path, idx_scale, w=110, h=150, window_size=16,
    ...
    interpolated_grad_numpy, result_numpy, interpolated_numpy = Path_gradient(tensor_lr.numpy(), model, idx_scale, attr_objective,
