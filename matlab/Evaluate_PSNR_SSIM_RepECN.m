function Evaluate_PSNR_SSIM_RepECN()
...
record_results_txt = ['PSNR_SSIM_Results_', degradation,'_RepECN.txt'];
...
record_means_results_txt = ['PSNR_SSIM_Means_Results_', degradation,'_RepECN.txt'];
