...
%     ImLRx4 = imresize(ImHR, 1/4, 'bicubic');
    ImLRx8 = imresize(ImHR, 1/8, 'bicubic');
    % name image
    digit = IdxIm;
...
%     FolderLRx2 = fullfile(path_save, 'DIV2K_train_LR_bicubic', 'X2');
%     FolderLRx3 = fullfile(path_save, 'DIV2K_train_LR_bicubic', 'X3');
%     FolderLRx4 = fullfile(path_save, 'DIV2K_train_LR_bicubic', 'X4');
    FolderLRx8 = fullfile(path_save, 'DIV2K_train_LR_bicubic', 'X8');
